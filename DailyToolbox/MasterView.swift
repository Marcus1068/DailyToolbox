...
extension ToolSection {
    static let catalogue: [ToolSection] = [
        ...
        ToolSection(title: "Science", items: [
            ...
            ToolItem(id: "showPeriodicTable", name: "Periodic Table",      subtitle: "118 elements · Groups & periods", icon: "atom",                           color: Color(red: 0.20, green: 0.75, blue: 0.55), segueId: "showPeriodicTable"),
        ]),
        ToolSection(title: "Tools", items: [
            ToolItem(id: "showHolidays",      name: "Holidays",subtitle: "DE · AT · CH · FR · IT · DK",       icon: "flag.fill",                      color: Color(red: 0.95, green: 0.75, blue: 0.20), segueId: "showHolidays"),
            ...
            ToolItem(id: "showBarcodeScanner", name: "Barcode Scanner", subtitle: "EAN · QR · Code 128", icon: "barcode.viewfinder", color: Color(red: 0.15, green: 0.65, blue: 0.90), segueId: "showBarcodeScanner"),
            ...
            ToolItem(id: "showGermanHolidays",name: "Holidays",subtitle: "DE · AT · CH · FR · IT · DK",       icon: "flag.fill",                      color: Color(red: 0.85, green: 0.15, blue: 0.15), segueId: "showGermanHolidays"),
