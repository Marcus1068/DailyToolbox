...
class CalendarCalculationViewController: UIViewController, UIPointerInteractionDelegate {
    ...
    @IBAction func easterButton(_ sender: UIButton) {
        ...
        daysLabel.text = "\(result) " + NSLocalizedString("days until Easter", comment: "days until Easter") + ": " + easterDate.toMediumDateString()
    }
    ...
    @IBAction func christmasButton(_ sender: UIButton) {
        ...
        daysLabel.text = "\(result) " + NSLocalizedString("days until Christmas", comment: "days until Christmas") + ": " + (nextChristmas?.toMediumDateString() ?? "")
    }
    ...
    @IBAction func makeCalenderAction(_ sender: UIButton) {
        ...
        message += " " + self.date.toMediumDateString()
        ...
        let submitAction = UIAlertAction(title: submit, style: .default) { [unowned ac] _ in
            ...
            Task {
                try? await calendar.addEventToCalendar(title: result, description: desc, startDate: self.date, endDate: endDate)
            }
        }
